...
public class Main {
    ...
    public static void main(String[] args) throws IOException, InvalidClassFileException, ClassHierarchyException, CancelException {
        //输入所需要读取的文件夹名字
        String FolderName = "0-CMD";
        //输入更改目录的情况
        String change_info = "givenData/ClassicAutomatedTesting/"+FolderName+"/data/change_info.txt";
        //使用CHA
        ...
        printChange.PrintChange(scope,FolderName,change_info);
    }
}
